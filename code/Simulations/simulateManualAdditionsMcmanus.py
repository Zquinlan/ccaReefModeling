...
workers = 200 # Setting the number of processors. 16 are available on my machine. Running with 14 processors took x mins

models = {}

for m in ['macroMinus', 'biyearlyAdditions', 'yearlyAdditions', 'biyearlyCCAMacro', 'yearlyCCAMacro']:
